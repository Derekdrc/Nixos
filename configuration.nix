...
#    enable = false;
  ...
  #install gnome native connector for extensions?
  ...
  services.displayManager.autoLogin.user = "derekd";
  ...
  environment.systemPackages = with pkgs; [
    ...
    wget
    vesktop
#    discord #comment out discord while vesktop is working again
    spotify
    librewolf
    via
    mangohud
...
#  };
  ...
  # Install fish for console
  programs.fish.enable = true;
  # Assign as defualt shell
